    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen={false} forceOverscroll={false}>
                ...
                <IonModal isOpen={isOpen} onDidDismiss={()=>setIsOpen(false)} id={`billing-address-edit`} className="post-price-modal w-100" canDismiss={canDismiss} initialBreakpoint={1} breakpoints={[0, 1]}>
